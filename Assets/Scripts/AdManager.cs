...
public class AdManager : MonoBehaviour
{
    ...
    private string appID = "ca-app-pub-6351610926806883~6734212971";

    // test ids for every ad, change origional when publishing to play store

// **************Banner Ad Id & var****************
    private BannerView bannerView;
    private string bannerID = "ca-app-pub-6351610926806883/6758457224";

// **************Interstitial Ad Id & var****************
    private InterstitialAd fullscreenAd;
    private string fullscreenAdID = "ca-app-pub-6351610926806883/5497152923";
